  ...
  return (
    <div className="mx-auto">
      ...
      <div className="lg:hidden">
        <p className="my-4 text-2xl brand-text-color font-semibold text-center">
          Share your{" "}
      ...
      <div className="hidden 2xl:block">
        <p className="my-4 text-2xl brand-text-color font-medium text-center">
          <span className="text-purple-600 hover:text-purple-800">
            Let&apos;s
          </span>{" "}
          have a{" "}
      ...
      <ContactForm />
      <p className="text-center brand-text-color font-semibold text-2xl mt-4 mb-8">
      ...
      <div className="grid grid-cols-2 my-4">
        <div className="col-span-1 flex flex-col justify-center items-center">
          ...
          <p className="brand-text-color-secondary">Connect on LinkedIn</p>
        </div>
        <div className="col-span-1 flex flex-col justify-center items-center">
          <a href="https://github.com/kylewilk567">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 496 512"
              height="36"
          ...
          <p className="brand-text-color-secondary">View My Projects</p>
        </div>
      </div>
    </div>
  );
